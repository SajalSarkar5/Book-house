...
const Moredetails = () => {
    ...
    console.log(Object.keys(loader).toString())

    const { name, image, type, price, area, discription, userEmail, userName } = loader;
    const handelSubmit = (e) => {
        ...
        const data = { buyUserName, buyUserEmail, date, text, name, image, type, price, area, discription, userEmail, userName }
    ...
    return (
        <div>
            ...
            <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg" src={loader.image} alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{loader.name}</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">{loader.discription}</p>
                    <div>
                        <p className='text-xl'>{loader.price}</p>
                    </div>
                    <div onClick={() => document.getElementById('my_modal_4').showModal()} class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Book Now
                ...
                <div className="modal-box w-11/12 max-w-5xl">
                    ...
                    <form onSubmit={handelSubmit}>
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled defaultValue={loader?.userName} type="name" name="name" id="floating_email" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled defaultValue={loader?.image} type="image" name="image" id="floating_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input disabled defaultValue={user.email} type="email" name="email" id="floating_repeat_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            <div class="relative z-0 w-full mb-6 group">
                                <input disabled defaultValue={loader.userEmail} type="userEmail" name="userEmail" id="floating_first_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input type="date" name="date" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="grid md:grid-cols-2 md:gap-6">
                            ...
                            <div class="relative z-0 w-full mb-6 group">
                                <input disabled defaultValue={loader.price} type="text" name="price" id="floating_company" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
